...
class Activity_EditProduct : AppCompatActivity() {
    ...
    private lateinit var al_editProductCheck: ArrayList<ModelEditProduct>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapterR_editProducts = AdapterR_EditProduct(al_editProduct, this@Activity_EditProduct, isContracted, false)
    ...
    private fun updateRecyclerAdapter() {
        ...
        adapterR_editProducts = AdapterR_EditProduct(al_editProduct, binding.root.context, isContracted, isAllInto)
    ...
    private fun isNotDuplicatedAd(array: ArrayList<ModelEditProduct>,c_Product: String): Boolean{
        var result = true
        for(model in array){
    ...
    private fun escogerimagenGaleria() {
        if (Permissions.siHayPermisoDeAlmacenamiento(this@Activity_EditProduct)) {
            ...
            Permissions.pedirPermisoDeAlmacenamiento(this@Activity_EditProduct, GALLERY_PERMISSION_CODE)
        }
    }
    ...
    private fun cutImage(uri1: Uri, uri2: Uri) {
        try {
            ...
            Toast.makeText(this@Activity_EditProduct, getString(R.string.error), Toast.LENGTH_SHORT).show()
        }
    }
